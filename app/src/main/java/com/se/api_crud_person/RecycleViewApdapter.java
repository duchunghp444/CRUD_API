...
public class RecycleViewApdapter extends RecyclerView.Adapter<RecycleViewApdapter.RecycleViewHolder> {
    ...
    private LinkedList<com.se.api_crud_person.Person> linkedList;
    private LayoutInflater inflater;
    private Context context;
    private AlertDialog alertDialog;
    public RecycleViewApdapter(LinkedList<com.se.api_crud_person.Person> linkedList, Context context) {
    ...
    public RecycleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recycleview_person, parent, false);
        return new RecycleViewHolder(view, this);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleViewHolder holder, int position) {
        com.se.api_crud_person.Person person = linkedList.get(position);
        holder.tvStudentId.setText(String.valueOf(person.getId()));
        holder.tvName.setText(person.getName());
        holder.tvClass.setText(person.getClassroom());
        holder.tvStatus.setText(person.getStatus());
        holder.tvWorking.setText(person.getWorking());
        ...
        public RecycleViewHolder(View view, RecycleViewApdapter adapter) {
            ...
            btnDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    com.se.api_crud_person.Person element = linkedList.get(position);
