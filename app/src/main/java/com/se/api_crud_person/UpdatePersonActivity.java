    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UpdatePersonActivity.this, PersonInfoActivity.class));
            }
        });
    ...
    private void putDataToJsonAPI(String url, int id) {
        StringRequest stringRequest = new StringRequest(
            ...
            public void onResponse(String response) {
                Toast.makeText(UpdatePersonActivity.this, "Update Successfully!", Toast.LENGTH_SHORT).show();
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(UpdatePersonActivity.this, "Error by Post data!", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
